...
import threading #veri akışı bozulmasın diye
import recorder
import transcriptor
import painter
import time
...
#ses kaydı başlatılsın denildiğinde neler olmalı;
def start_recording():
